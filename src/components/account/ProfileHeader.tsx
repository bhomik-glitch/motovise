            ...
            <CardContent className="space-y-6">
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 pb-6 border-b">
                    <div className="relative group">
                        <div className="relative h-24 w-24 rounded-full overflow-hidden ring-4 ring-slate-100 dark:ring-slate-800 transition-all duration-300 group-hover:ring-primary/20">
                            {user?.image ? (
                                <Image
                                    src={user.image}
                                    alt={user.name || "User"}
