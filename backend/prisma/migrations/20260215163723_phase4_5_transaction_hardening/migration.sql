...
-- CreateEnum
CREATE TYPE "InventoryLogType" AS ENUM ('PURCHASE', 'SALE', 'RETURN', 'ADJUSTMENT', 'DAMAGE', 'RESTOCK');
...
CREATE TABLE "ManagerPermissions" (
    ...
    "canUpdateOrderStatus" BOOLEAN NOT NULL DEFAULT false,
...
-- CreateIndex
CREATE UNIQUE INDEX "ManagerPermissions_userId_key" ON "ManagerPermissions"("userId");

-- CreateIndex
CREATE INDEX "ManagerPermissions_userId_idx" ON "ManagerPermissions"("userId");
...
-- CreateIndex
CREATE INDEX "OrderSequence_date_idx" ON "OrderSequence"("date");

-- AddForeignKey
ALTER TABLE "ManagerPermissions" ADD CONSTRAINT "ManagerPermissions_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
